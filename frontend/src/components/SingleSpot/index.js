        ...
        <div className="detail-page">
            ...
            <div className="spot-images">
                ...
                <div className="smaller-images">
                    {spot.SpotImages && spot.SpotImages[1] && <img src={spot.SpotImages[1].url} alt="Smaller Image" />}
                    {spot.SpotImages && spot.SpotImages[2] && <img src={spot.SpotImages[2].url} alt="Smaller Image" />}
                </div>
            </div>
